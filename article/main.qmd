...
Com auxílio do critério de Kaiser e do modelo Broken-Stick (@fig-acp), foram escolhidos 2 componentes para serem analisados, pois já concentram 71,7% da variância total e condensam múltiplas dimensões para uma análise bidimensional.
